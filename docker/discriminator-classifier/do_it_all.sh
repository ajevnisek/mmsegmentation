...
runai submit -g 1 -e BASE_DIR='/storage/jevnisek/discriminator-classifier' \
  ...
  -e DATASET='Hday2night' -e EPOCHS=20 -e BATCH_SIZE=128 \
...
runai submit -g 1 -e BASE_DIR='/storage/jevnisek/discriminator-classifier' \
  -e  DATASET_ROOT='/storage/jevnisek/ImageHarmonizationDataset/' \
  -e DATASET='HFlickr' -e EPOCHS=20 -e BATCH_SIZE=128 \
  -e GAN_MODE='vanilla' -e LEARNING_RATE=1e-3 \
...
runai submit -g 1 -e BASE_DIR='/storage/jevnisek/discriminator-classifier' \
  -e  DATASET_ROOT='/storage/jevnisek/ImageHarmonizationDataset/' \
  -e DATASET='HAdobe5k' -e EPOCHS=20 -e BATCH_SIZE=128 \
  -e GAN_MODE='vanilla' -e LEARNING_RATE=1e-3 \
...
runai submit -g 1 -e BASE_DIR='/storage/jevnisek/discriminator-classifier' \
  -e  DATASET_ROOT='/storage/jevnisek/ImageHarmonizationDataset/' \
  -e DATASET='HCOCO' -e EPOCHS=20 -e BATCH_SIZE=128 \
  -e GAN_MODE='vanilla' -e LEARNING_RATE=1e-3 \
