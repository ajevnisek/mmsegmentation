...
def create_discriminator():
    ...
    Options = namedtuple('Options', ['output_nc',
                                     'ndf', 'n_layers_D',
                                     'norm', 'init_type', 'init_gain',
                                     'gpu_ids'])
    opt = Options(output_nc=3, n_layers_D=3, ndf=64, norm='instance',
    ...
    netD = networks.init_net(netD, opt.init_type, opt.init_gain, opt.gpu_ids)
    return netD
